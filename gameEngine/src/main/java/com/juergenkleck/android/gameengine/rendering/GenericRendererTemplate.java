...
import com.juergenkleck.android.gameengine.R;
...
import com.juergenkleck.android.gameengine.screens.GenericScreenTemplate;
...
public abstract class GenericRendererTemplate implements BasicEngine {
    ...
    public GenericRendererTemplate(Context context, Properties properties) {
        ...
        renderingSystem = (com.juergenkleck.android.gameengine.RenderingSystem) properties.get(EngineConstants.GameProperties.RENDERING_SYSTEM);
